...
export function IconTrash(props) {
  return (
    <svg width="19" height="19" viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M4 7h16M9 7V5a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2m-9 0 1 13a2 2 0 0 0 2 1.9h4a2 2 0 0 0 2-1.9L18 7"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function IconEyeOff(props) {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" {...props}>
      <path
        d="M3 3l18 18M10.6 10.7a2.6 2.6 0 0 0 3.7 3.7M6.5 6.7C4.4 8.1 2.9 10 2 12c1.6 3.6 5.4 7 10 7 1.6 0 3.1-.4 4.5-1.1M9.8 4.3A10.9 10.9 0 0 1 12 4c4.6 0 8.4 3.4 10 7-.5 1.2-1.2 2.4-2.1 3.4"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function IconCheck(props) {
  return (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" {...props}>
      <path d="M4 12.5l5 5L20 7" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
